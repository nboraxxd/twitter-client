import { Caption, Controls, Gesture, MediaPlayer, MediaProvider, Poster, Time } from '@vidstack/react'
...
export default function Home() {
  return (
    <MediaPlayer
      title="..."
      src="http://localhost:3000/static/stream-hls-video/_D5X6LoiVXRarFDTP8pPA/master.m3u8"
      aspectRatio="16/9"
